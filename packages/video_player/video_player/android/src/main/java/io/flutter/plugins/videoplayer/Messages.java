...
public class Messages {
  ...
  public static class DurationWatchedMessage {
    ...
    static DurationWatchedMessage fromMap(HashMap map) {
      ...
      Object textureId = map.get("textureId");
      fromMapResult.textureId = (textureId == null) ? null : ((textureId instanceof Integer) ? (Integer)textureId : (Long)textureId);
      Object durationWatched = map.get("durationWatched");
      fromMapResult.durationWatched = (durationWatched == null) ? null : ((durationWatched instanceof Integer) ? (Integer)durationWatched : (Long)durationWatched);
      return fromMapResult;
    }
  }

  /** Generated class from Pigeon that represents data sent in messages. */
  public static class MediaItemInfoMessage {
    private Long textureId;
    public Long getTextureId() { return textureId; }
    public void setTextureId(Long setterArg) { this.textureId = setterArg; }
    ...
    public void setInfo(HashMap setterArg) { this.info = setterArg; }
    ...
    static MediaItemInfoMessage fromMap(HashMap map) {
      MediaItemInfoMessage fromMapResult = new MediaItemInfoMessage();
      Object textureId = map.get("textureId");
      fromMapResult.textureId = (textureId == null) ? null : ((textureId instanceof Integer) ? (Integer)textureId : (Long)textureId);
      Object info = map.get("info");
      fromMapResult.info = (HashMap)info;
      return fromMapResult;
    }
  }
  ...
  public interface VideoPlayerApi {
    ...
    static void setup(BinaryMessenger binaryMessenger, VideoPlayerApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.VideoPlayerApi.durationWatched", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            HashMap<String, HashMap> wrapped = new HashMap<>();
            try {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.VideoPlayerApi.updateMediaItemInfo", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            HashMap<String, HashMap> wrapped = new HashMap<>();
            try {
