...
-(NSDictionary*)toMap;
@end
@interface FLTMediaItemInfoMessage ()
+(FLTMediaItemInfoMessage*)fromMap:(NSDictionary*)dict;
-(NSDictionary*)toMap;
@end
...
@implementation FLTMediaItemInfoMessage
+(FLTMediaItemInfoMessage*)fromMap:(NSDictionary*)dict {
  FLTMediaItemInfoMessage* result = [[FLTMediaItemInfoMessage alloc] init];
  result.textureId = dict[@"textureId"];
  if ((NSNull *)result.textureId == [NSNull null]) {
    result.textureId = nil;
  }
...
-(NSDictionary*)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.textureId ? self.textureId : [NSNull null]), @"textureId", (self.info ? self.info : [NSNull null]), @"info", nil];
}
@end
...
void FLTVideoPlayerApiSetup(id<FlutterBinaryMessenger> binaryMessenger, id<FLTVideoPlayerApi> api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel
        messageChannelWithName:@"dev.flutter.pigeon.VideoPlayerApi.updateMediaItemInfo"
        binaryMessenger:binaryMessenger];
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        FLTMediaItemInfoMessage *input = [FLTMediaItemInfoMessage fromMap:message];
        [api updateMediaItemInfo:input error:&error];
        callback(wrapResult(nil, error));
      }];
    }
    else {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel
        messageChannelWithName:@"dev.flutter.pigeon.VideoPlayerApi.clearMediaItemInfo"
        binaryMessenger:binaryMessenger];
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        FLTTextureMessage *input = [FLTTextureMessage fromMap:message];
        [api clearMediaItemInfo:input error:&error];
        callback(wrapResult(nil, error));
      }];
    }
    else {
